function GetCore()
    ...
    if Config.Framework == "oldesx" then
        ...
        if not object then
            print(
                "codem-pausemenu-remake::Framework is not selected in the config correctly if you're sure it's correct please check your events to get framework object")
        end
    end
    ...
    if Config.Framework == 'autodetect' then
        ...
        if not object then
            print("codem-pausemenu-remake::Auto detect couldn't detect your framework please check your event to get framework object")
        else
            print("codem-pausemenu-remake::Framework object found : ", Framework)
        end
    end
